  ...
  routes: [
    {
      ...
      routes: [
        { exact: true, path: '/', redirect: '/forum' },
        {
          ...
          routes: [
            ...
            { exact: true, path: '/forum/add', component: '@/pages/forum/add' },
            {
              exact: true,
              path: '/forum/:id',
              component: '@/pages/forum/[id]',
            },
            {
              exact: true,
              path: '/forum/topic/:id',
              component: '@/pages/forum/topic[id]',
            },
            { component: '@/pages/404' },
          ],
        },
        {
          exact: false,
          path: '/message',
          component: '@/pages/message/_layout',
          routes: [
            {
              exact: true,
              path: '/message',
              component: '@/pages/message/index/_layout',
            },
            {
              exact: true,
              path: '/message/add',
              component: '@/pages/message/add',
            },
            {
              exact: true,
              path: '/message/view',
              component: '@/pages/message/view',
            },
            { component: '@/pages/404' },
          ],
        },
        ...
        { exact: true, path: '/forgot', component: '@/pages/action/forgot' },
        {
          exact: true,
          path: '/forgot/reset',
          component: '@/pages/action/forgot.verify',
        },
        {
          exact: true,
          path: '/register',
          component: '@/pages/action/register',
        },
        {
          exact: true,
          path: '/register/verify',
          component: '@/pages/action/register.verify',
        },
