...
export default connect(({ user }: { user: User }) => ({ user }))(
  (props: any) => {
    ...
    function onSignature() {
      Swal.confirm('您确定要修改个性签名吗？').then((res) => {
        if (!res) {
          return;
        }
        ...
        <li>
          ...
          <Note>
            <div className={styles.container}>
              ...
              <div className={styles.wrapper}>
                <Button onClick={onNickname}>确认修改</Button>
              </div>
            </div>
          </Note>
          <Note>
            <div className={styles.container}>
              ...
              <div className={styles.wrapper}>
                <label htmlFor="signature" style={{ whiteSpace: 'nowrap' }}>
                  新个性签名
                </label>
                &nbsp;
                <input
              ...
              <div className={styles.wrapper}>
                <Button onClick={onSignature}>确认修改</Button>
              </div>
            </div>
          </Note>
          <Note>
            <div className={styles.container}>暂不支持修改邮箱</div>
          </Note>
        </li>
      </ul>
    ) : (
